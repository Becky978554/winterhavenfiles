                  ...
                  function renderAdjustedWeights() {
                    try {
                      ...
                      function _weanWeightFor(l, birth) {
                        try {
                          // prefer explicit wean/latest fields if they have a date after birth
                          ...
                          if (wDateRawFields) {
                            ...
                            if (!isNaN(d.getTime())) {
                              if (birth && d.getTime() === birth.getTime()) {
                                // this dated weight is on birth day — treat as birth weight, not wean
                              } else {
                          ...
                          // search in weights[] for the latest weight recorded after birth
                          if (Array.isArray(l.weights) && birth) {
                            const later = [];
                            for (let i = 0; i < l.weights.length; i++) {
                              try {
